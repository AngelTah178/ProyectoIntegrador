<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
      ...
      // crear paciente
      $sql_paciente = "INSERT INTO pacientes (nombre_paciente, apellido_p, apellido_m, fecha_nacimiento, sexo, telefono, ocupacion, estado_civil) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
      ...
      $sql_historia = "INSERT INTO historias (id_paciente, fecha, motivo_consulta, peso, altura, imc, igc, tratamiento, observaciones, id_doctor) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
